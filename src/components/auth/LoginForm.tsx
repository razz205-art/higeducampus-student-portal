...
export default function LoginForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Hard navigation (not router.push) so the browser makes a fresh
    // top-level request that's guaranteed to carry the freshly-set
    // session cookie, avoiding the race that bounced back to /login.
