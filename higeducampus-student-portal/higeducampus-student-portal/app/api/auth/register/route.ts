 ...
 * an existing admin (e.g. from a future /academic-admin/users management
 * screen) — never through an open signup form. This prevents privilege
 * escalation via a public endpoint.
 */
